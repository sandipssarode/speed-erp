...
export const menu = [
  {
    ...
    links: [
      ...
      { label: "BOM Master",            path: "/masters/bom-master" },
    ],
  },
  {
    ...
    children: {
      Transaction: [
        ...
        { label: "Maintenance Request",   path: "/asset-management/maintenance-request" },
        { label: "Spare Parts",           path: "/asset-management/spare-parts" },
        { label: "Maintenance Plan",      path: "/asset-management/maintenance-plan" },
      ],
    },
  },
  {
