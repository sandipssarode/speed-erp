    ...
    <Layout>
      <div className="space-y-3 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-1.5 text-xs text-gray-400">
          ...
          <button onClick={() => navigate("/system/business-units")} className="hover:text-blue-500 transition-colors">Business Unit Master</button>
          {form.locationCode && <><ChevronRight size={12} /><span className="text-blue-600 font-medium">{form.locationCode}</span></>}
        </div>
