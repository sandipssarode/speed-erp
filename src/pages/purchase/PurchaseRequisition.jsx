            ...
            {activeTab === "items" && (
              <div className="space-y-3">
                ...
                {!isReadOnly && (
                  <button
                    onClick={addItem}
                    className="flex items-center gap-1.5 text-xs text-brand-600 hover:text-blue-800 font-medium"
                  >
                ...
                {!isReadOnly && (
                  <div className="flex items-center gap-3 bg-gray-50 border border-gray-200 rounded p-3 text-xs flex-wrap">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 text-xs bg-brand-600 hover:bg-brand-700 text-white rounded font-medium"
                    >
                      Apply to All
                    </button>
