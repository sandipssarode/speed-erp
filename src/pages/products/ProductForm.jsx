    ...
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute top-full left-0 right-0 z-20 bg-white border border-gray-200 rounded shadow-lg p-2 space-y-0.5 max-h-48 overflow-y-auto">
          ...
          <button onClick={() => setOpen(false)} className="w-full text-xs text-blue-600 text-center py-1.5 hover:bg-blue-50 rounded mt-1 border-t border-gray-100">Done</button>
        </div>
      )}
    </div>
  );
    ...
    <div className="relative" ref={ref}>
      <div className="flex flex-wrap gap-1 min-h-[34px] px-2 py-1 border border-gray-300 rounded bg-white hover:border-gray-400">
        {selected.map((code) => {
          ...
          return (
            <span key={code} className="inline-flex items-center gap-1 bg-blue-50 text-blue-700 text-xs px-2 py-0.5 rounded border border-blue-200">
        ...
        <div className="absolute top-full left-0 right-0 z-20 bg-white border border-gray-200 rounded shadow-lg max-h-44 overflow-y-auto">
          {suggestions.slice(0, 10).map((p) => (
            <button key={p.code} type="button"
              ...
              className="w-full text-left px-3 py-2 text-sm hover:bg-blue-50 flex items-center gap-2.5 border-b border-gray-50">
              <span className="font-mono text-xs text-blue-600 w-14 shrink-0">{p.code}</span>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-lg shadow-2xl w-[500px] max-w-full mx-4">
        ...
        <div className="px-5 py-3 border-t border-gray-200 flex justify-end gap-2">
          ...
          <button onClick={save} className="px-4 py-1.5 text-sm bg-blue-600 hover:bg-blue-700 text-white rounded flex items-center gap-1.5"><Save size={13} /> Save Category</button>
        </div>
      </div>
    </div>
  );
    ...
    <Layout>
      <div className="space-y-3 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-1.5 text-xs text-gray-400">
          ...
          <button onClick={() => navigate("/products")} className="hover:text-blue-500 transition-colors">Product Master</button>
                ...
                <tbody>
                  {form.changelog.map((c, i) => (
                    <tr key={i} className="border-b border-gray-50">
                      ...
                      <td className="py-1.5"><span className={`px-1.5 py-0.5 rounded text-xs ${c.action === "Created" ? "bg-green-50 text-green-600" : "bg-blue-50 text-blue-600"}`}>{c.action}</span></td>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {!isReadOnly && (
                        <button onClick={() => setShowCategoryModal(true)}
                          className="flex items-center gap-1 text-xs px-2.5 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded">
            ...
            {activeTab === "variants" && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  {!isReadOnly && (
                    <button onClick={addVariant} className="flex items-center gap-1.5 text-xs px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded">
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    {!isReadOnly && (
                      <button onClick={addConv} className="flex items-center gap-1.5 text-xs px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded">
              ...
              <div className="max-w-2xl space-y-5">
                ...
                {(form.categoryCode) && (
                  <div className="bg-blue-50 border border-blue-100 rounded p-3 space-y-1">
                    ...
                    <p className="text-xs text-blue-600">Income: {form.catIncomeAccount || "Not set"}</p>
                    <p className="text-xs text-blue-600">Expense: {form.catExpenseAccount || "Not set"}</p>
                    <p className="text-xs text-blue-600">Cost Method: {form.costMethod || "Not set"}</p>
                  </div>
                )}
              </div>
            )}
