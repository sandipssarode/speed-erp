    ...
    <Layout>
      <div className="space-y-3 max-w-5xl mx-auto">
        ...
        <div className="flex items-center gap-1.5 text-xs text-gray-400">
          ...
          <button onClick={() => navigate("/masters/asset-master")} className="hover:text-violet-500 transition-colors">Asset Master</button>
          {form.assetId && <><ChevronRight size={12} /><span className="text-violet-600 font-medium">{form.assetId}</span></>}
        </div>
