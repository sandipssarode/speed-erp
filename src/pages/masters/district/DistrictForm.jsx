    ...
    <Layout>
      <div className="space-y-3 max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-1.5 text-xs text-gray-400">
          <button onClick={() => navigate("/masters/district")} className="hover:text-violet-500 transition-colors">District Master</button>
          {form.districtCode && <><ChevronRight size={12} /><span className="text-violet-600 font-medium">{form.districtCode}</span></>}
        </div>
