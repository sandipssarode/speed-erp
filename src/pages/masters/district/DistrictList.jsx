...
export default function DistrictList() {
  ...
  useEffect(() => { setPage(1); }, [search, filterState]);
            ...
            <table className="w-full text-sm min-w-[600px]">
              <thead>
                <tr className="bg-violet-700">
                  <th className="text-left px-4 py-2.5 text-xs font-semibold text-white uppercase tracking-wide">District Code</th>
                  <th className="text-left px-4 py-2.5 text-xs font-semibold text-white uppercase tracking-wide">District Name</th>
                  <th className="text-left px-4 py-2.5 text-xs font-semibold text-white uppercase tracking-wide">State</th>
                  <th className="text-left px-4 py-2.5 text-xs font-semibold text-white uppercase tracking-wide">Headquarters</th>
              ...
              <tbody>
                {paginated.length === 0 ? (
                  ...
                  paginated.map((r, i) => (
                    ...
                    >
                      <td className="px-4 py-2.5 font-mono text-xs font-semibold text-violet-600">{r.districtCode}</td>
