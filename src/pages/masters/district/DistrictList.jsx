...
export default function DistrictList() {
  ...
  const filtered = records
    ...
    .sort((a, b) => {
      const r = (a.districtName || "").localeCompare(b.districtName || "");
      ...
      <div className="max-w-6xl mx-auto space-y-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            Manage districts, states &amp; headquarters
          </p>
        </div>
            ...
            <table className="w-full text-sm min-w-[760px]">
              <thead>
                <tr className="bg-gradient-to-r from-brand-800 to-brand-600">
                  ...
                  <th className={th}>District Code</th>
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr>
                    ...
                    >
                      {records.length === 0
                        ? 'No districts yet. Click "New District" to add one.'
