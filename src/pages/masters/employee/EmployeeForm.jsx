    ...
    <Layout>
      <div className="space-y-3 max-w-4xl mx-auto">
        <div className="flex items-center gap-1.5 text-xs text-gray-400">
          ...
          <button onClick={() => navigate("/masters/employee")} className="hover:text-violet-500 transition-colors">Employee</button>
          {form.employeeId && <><ChevronRight size={12} /><span className="text-violet-600 font-medium">{form.employeeId}</span></>}
        </div>
