    ...
    <Layout>
      <div className="space-y-3 max-w-3xl mx-auto">
        <div className="flex items-center gap-1.5 text-xs text-gray-400">
          ...
          <button onClick={() => navigate("/masters/department")} className="hover:text-brand-500 transition-colors">Department</button>
          {form.departmentCode && <><ChevronRight size={12} /><span className="text-brand-600 font-medium">{form.departmentCode}</span></>}
        </div>
