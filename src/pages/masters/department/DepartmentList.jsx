              ...
              <tbody>
                {paginated.length === 0 ? (
                  ...
                  paginated.map((r, i) => (
                    ...
                    >
                      <td className="px-4 py-2.5 font-mono text-xs font-semibold text-brand-600">{r.departmentCode}</td>
                      <td className="px-4 py-2.5 font-medium text-gray-800">{r.departmentName}</td>
                      <td className="px-4 py-2.5">
                        <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
                          <button onClick={() => navigate(`/masters/department/${r.id}`)} className="p-1.5 text-brand-500 hover:text-brand-600 hover:bg-brand-50 rounded" title="Edit">
                            <Edit2 size={13} />
                          </button>
