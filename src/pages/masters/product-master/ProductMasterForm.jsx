    ...
    <Layout>
      <div className="space-y-3 max-w-4xl mx-auto">
        <div className="flex items-center gap-1.5 text-xs text-gray-400">
          ...
          <button onClick={() => navigate("/masters/product-master")} className="hover:text-blue-500 transition-colors">Product Master</button>
          {form.productCode && <><ChevronRight size={12} /><span className="text-blue-600 font-medium">{form.productCode}</span></>}
        </div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded p-4 space-y-4">
              ...
              <Field label="Description">
                <textarea
                  ...
                  rows={3}
                  className={`w-full px-2.5 py-1.5 text-sm border rounded focus:outline-none focus:ring-1 focus:ring-blue-400 resize-none transition-colors ${isReadOnly ? "bg-gray-100 text-gray-500 cursor-not-allowed border-gray-200" : "bg-white border-gray-300 hover:border-gray-400"}`}
                />
              </Field>
            </div>
