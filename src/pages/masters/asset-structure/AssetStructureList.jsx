...
export default function AssetStructureList() {
  ...
  const filtered = records
    ...
    .sort((a, b) => {
      const r = (a.locationName || "").localeCompare(b.locationName || "");
      ...
      <div className="max-w-6xl mx-auto space-y-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            Manage locations, sites &amp; warehouses
          </p>
        </div>
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <div className="relative flex-1 min-w-[220px] max-w-sm">
            ...
            <input
              type="text"
              placeholder="Search asset structuresâ€¦"
              value={search}
              ...
              <thead>
                <tr className="bg-gradient-to-r from-brand-800 to-brand-600">
                  <th className={th}>
                    ...
                    >
                      Location Name <ChevronsUpDown size={13} className="opacity-70" />
                    </button>
                  </th>
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr>
                    ...
                    >
                      {records.length === 0
                        ? 'No asset structures yet. Click "New Structure" to add one.'
                      ...
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-3">
                          <span className="w-9 h-9 rounded-lg bg-brand-50 ring-1 ring-brand-100 text-brand-700 flex items-center justify-center text-xs font-bold shrink-0">
                            {(r.locationId || r.locationName || "?").slice(0, 2).toUpperCase()}
                          </span>
