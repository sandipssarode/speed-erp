    ...
    <Layout>
      <div className="space-y-3 max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-1.5 text-xs text-gray-400">
          <button onClick={() => navigate("/system/countries")} className="hover:text-brand-500 transition-colors">Country Master</button>
          {form.countryCode && <><ChevronRight size={12} /><span className="text-brand-600 font-medium">{form.countryCode}</span></>}
        </div>
