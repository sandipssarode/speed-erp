              ...
              <tbody>
                {paginated.length === 0 ? (
                  ...
                  paginated.map((r, i) => (
                    ...
                    >
                      <td className="px-4 py-2.5 font-mono text-xs font-semibold text-blue-600">{r.subtypeId}</td>
                      ...
                      <td className="px-4 py-2.5">
                        <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
                          <button onClick={() => navigate(`/masters/product-subtype/${r.id}`)} className="p-1.5 text-blue-500 hover:text-blue-700 hover:bg-blue-50 rounded" title="Edit"><Edit2 size={13} /></button>
