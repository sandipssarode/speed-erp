...
export default function ProductSubtypeList() {
  ...
  useEffect(() => { setPage(1); }, [search, statusFilter, filterType]);
  ...
  const filtered = records
    ...
    .sort((a, b) => {
      const r = (a.subtypeName || "").localeCompare(b.subtypeName || "");
                    ...
                    >
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-3">
                          <span className="w-9 h-9 rounded-lg bg-brand-50 ring-1 ring-brand-100 text-brand-700 flex items-center justify-center text-xs font-bold shrink-0">
                            {(r.subtypeId || "?").slice(0, 2).toUpperCase()}
                          </span>
                      ...
                      <td className="px-5 py-3.5">
                        ...
                        >
                          ...
                          <button
                            onClick={() => handleDelete(r.id, r.subtypeName)}
