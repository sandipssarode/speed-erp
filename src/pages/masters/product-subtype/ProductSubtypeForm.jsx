    ...
    <Layout>
      <div className="space-y-3 max-w-3xl mx-auto">
        <div className="flex items-center gap-1.5 text-xs text-gray-400">
          ...
          <button onClick={() => navigate("/masters/product-subtype")} className="hover:text-brand-500 transition-colors">Product Sub-type</button>
          {form.subtypeId && <><ChevronRight size={12} /><span className="text-brand-600 font-medium">{form.subtypeId}</span></>}
        </div>
