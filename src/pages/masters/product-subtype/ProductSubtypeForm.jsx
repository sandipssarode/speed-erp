...
import { Save, Trash2, Edit2, FileText, CheckCircle, AlertCircle, ChevronLeft, Tags } from "lucide-react";
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="px-6 py-7 space-y-6">
            ...
            <Row label="Product Type" required error={errors.productTypeId}>
              <select value={form.productTypeId} onChange={e => handleTypeChange(e.target.value)} disabled={isReadOnly} className={inputCls(isReadOnly, errors.productTypeId)}>
