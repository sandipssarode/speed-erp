...
export default function StateList() {
  ...
  useEffect(() => { setPage(1); }, [search, statusFilter, filterCountry]);
  ...
  const filtered = records
    ...
    .sort((a, b) => {
      const r = (a.stateName || "").localeCompare(b.stateName || "");
      ...
      <div className="max-w-6xl mx-auto space-y-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            Manage states, countries &amp; GST codes
          </p>
        </div>
            ...
            <table className="w-full text-sm min-w-[760px]">
              <thead>
                <tr className="bg-gradient-to-r from-brand-800 to-brand-600">
                  ...
                  <th className={th}>State Code</th>
                  <th className={th}>Country</th>
                  <th className={th}>GST State Code</th>
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr>
                    ...
                    >
                      {records.length === 0
                        ? 'No states yet. Click "New State" to add one.'
                      ...
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-3">
                          <span className="w-9 h-9 rounded-lg bg-brand-50 ring-1 ring-brand-100 text-brand-700 flex items-center justify-center text-xs font-bold shrink-0">
                            {(r.stateCode || "?").slice(0, 2).toUpperCase()}
                          </span>
