            ...
            <table className="w-full text-sm min-w-[800px]">
              ...
              <tbody>
                {paginated.length === 0 ? (
                  ...
                  <tr key={r.id} className={`border-b border-gray-200 hover:bg-brand-100 hover:scale-[1.01] cursor-pointer transition-all ${i % 2 !== 0 ? "bg-gray-50/50" : ""}`} onClick={() => navigate(`/asset-management/work-order/${r.id}`)}>
