...
export default function WorkOrderTypeList() {
  ...
  const handleDelete = async (id, name) => {
    if (!window.confirm(`Delete work order type "${name}"? This cannot be undone.`)) return;
    try {
      ...
      <div className="max-w-6xl mx-auto space-y-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            Define and manage work order classification types
          </p>
        </div>
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <div className="relative flex-1 min-w-[220px] max-w-sm">
            ...
            <input
              type="text"
              placeholder="Search work order typesâ€¦"
              value={search}
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5">
                      <div className="flex items-center justify-end gap-1.5" onClick={e => e.stopPropagation()}>
                        ...
                        <button
                          onClick={() => handleDelete(r.id, r.typeName)}
